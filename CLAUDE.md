...
| 14 | Options vol selling | scope 2026-05-02; Phases A+B+C+D-1..D-7 complete 2026-05-03; **Phase D-8 (walk-forward + CPCV harness) shipped 2026-05-03 with damaging findings**. Full 6-year SPX (1508 days, 2020-2025) ingested; 11 concrete strategy classes registered. **In-sample multi-year cumulative**: PCS bare +18% RoC, PCS+IC portfolio +5.0% RoC, JL+tight +4.3% RoC. **Walk-forward + CPCV reject all three**: every IS window has negative Sharpe (PCS -0.085, PCS+IC -0.039, JL+tight -0.033) because each 3y window includes 2022; CPCV (45 paths) median Sharpe +0.02 to +0.04, 33-42% of paths negative — far below the 0.8 gate. The headlines were artifacts of a single multi-year cumulative that depends on 2024 (bull) compounding past 2022 (bear); rolling discipline gates expose no positive in-sample edge. **Operational implication**: paper-trading at $250K is no longer well-supported by evidence. 628 tests passing. Live IBKR contract qualification verified on paper account DU7535411. **Open question for the operator**: (a) different strategies/underlyings/parameters, (b) re-validate the 0.8 median-Sharpe gate against academic short-vol research, or (c) stand down on options. |
