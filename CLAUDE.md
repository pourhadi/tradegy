...
| 15 | $5K options capital plan | written 2026-05-05. Two paths: (1) deploy doc-14's validated SPY+PCS+IC+JL+IV<0.25 at $5K capital — reproduced 16yr walk-forward 2026-05-05 at OOS Sharpe +0.867 / +$8.8K / 13.5% AnnRoC, gate PASSES, deployable today on existing data; (2) MES futures options 0DTE (intraday-compliant, requires Polygon $99/mo or CBOE Datashop $300-1k for data, NOT yet validated). Plan + Polygon probe script ready; data acquisition is the user's call. See `trading_platform_docs/15_5k_options_capital_plan.md`. |
